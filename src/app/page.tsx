...
console.log(response.txData.customData.paymasterParams.paymaster,
     ...
     response.txData.maxFeePerGas,
      ...
      paymasterInput: response.txData.customData.paymasterParams.paymasterInput.toString(),
      maxFeePerGas: response.txData.maxFeePerGas,
      gasLimit: response.txData.gasLimit
    });
    }
    catch{
    writeContractSponsored({
