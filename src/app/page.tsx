...
import { useLoginWithAbstract, useWriteContractSponsored, AbstractWalletProvider } from "@abstract-foundation/agw-react";
...
export default function Home() {
    ...
    const handleSubmitTransaction = async () => {
        ...
        try {
            const response = await callZyfiApi(address, contractAddress, encodedData, "0", 100);
            console.log(
            ...
            writeContractSponsored({
                ...
                paymasterInput: response.txData.customData.paymasterParams.paymasterInput,
    ...
    return (
        <div className="relative grid grid-rows-[1fr_auto] min-h-screen p-8 pb-20 sm:p-20 font-[family-name:var(--font-avenue-mono)] bg-black overflow-hidden">
            ...
            <main className="relative flex flex-col items-center justify-center z-10 text-white text-center">
                <div className="flex flex-col items-center gap-8">
                    <div className="flex flex-row">
                        <Image src="/abstract.svg" alt="Abstract logo" width={240} height={32} quality={100} priority />{" "}
                        <div className="flex flex-row text-4xl"> &nbsp;&lt;&gt; ZYFI</div>
                    </div>
                    <p className="text-md font-[family-name:var(--font-roobert)]">
                        Abstract Global Wallet &lt;&gt;
                        <code className="bg-white/[.06] px-1 py-0.5 rounded font-semibold">Zyfi Paymaster Integration</code>
                    </p>
                                ...
                                : "bg-gradient-to-r from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 border-transparent"
                                        ...
                                        >
                                            ...
                                            <span className="w-full text-center">
                                                {!transactionReceipt ? "Submit tx" : transactionReceipt.status === "success" ? "Success" : "Failed"}
                                            </span>
                                        </button>
                                    </div>
                                    {!!transactionReceipt && (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full max-w-4xl mx-auto mt-8 font-[family-name:var(--font-roobert)]">
                ...
                >
                    <svg className="w-6 h-6 mb-2 opacity-70" viewBox="0 0 24 24" fill="currentColor">
                ...
                >
                    ...
                    <h3 className="text-lg font-semibold mb-2 opacity-90">GitHub Examples</h3>
                ...
                >
                    ...
                    <h3 className="text-lg font-semibold mb-2 opacity-90">YouTube Channel</h3>
                    <p className="text-sm opacity-70">Watch our video tutorials on YouTube.</p>
                </a>
            </div>
        </div>
    );
